...
{
    NSString *logStr = [self zm_description:++arrayTabCount];
    arrayTabCount = 0;
    return logStr;
}

- (NSString *)zm_description:(NSInteger)depth
{
...
- (NSString *)descriptionWithLocale:(id)locale
{
    NSString *logStr = [self zm_description:++dictionaryTabCount];
...
- (NSString *)descriptionWithLocale:(id)locale
{
    NSString *logStr = [self zm_description:++setTabCount];
    setTabCount = 0;
    return logStr;
}
